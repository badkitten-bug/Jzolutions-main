...
title: Jzolutions template in depth
excerpt: While easy to get started, Jzolutions is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://Jzolutions.vercel.app/Jzolutions-template-in-depth
---
...
<CallToAction
  callToAction={{
    text: 'Get template',
    href: 'https://github.com/badkitten-bug/Jzolutions-main',
